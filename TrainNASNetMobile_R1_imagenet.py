...
conv_base = NASNetMobile(weights='imagenet', include_top=False, input_shape=input_shape)
...
os.chdir('/media/tohn/SSD/Orther_model/R1')

root_logdir = '/media/tohn/SSD/Orther_model/R1/my_logs_NASNetMobileR1'
def get_run_logdir():
    import time
...
model.save('./models/EffNet_NASNetMobileR1.h5')
