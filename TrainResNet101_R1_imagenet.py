...
conv_base = ResNet101(weights='imagenet', include_top=False, input_shape=input_shape)
...
root_logdir = '/media/tohn/SSD/Orther_model/R1/my_logs_ResNet101'
def get_run_logdir():
    import time
...
model.save('./models/EffNet_ResNet101R1.h5')
