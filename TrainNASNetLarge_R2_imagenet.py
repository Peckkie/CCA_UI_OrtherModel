...
model_dir = '/media/tohn/SSD/Orther_model/R1/models/EffNet_NASNetLargeR1.h5'
...
root_logdir = '/media/tohn/SSD/Orther_model/R2/my_logs_NASNetLargeR2'
def get_run_logdir():
    import time
...
model.save('./models/EffNet_NASNetLargeR2.h5')