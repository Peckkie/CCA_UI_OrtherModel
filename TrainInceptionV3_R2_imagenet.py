...
model_dir = '/media/tohn/SSD/Orther_model/R1/models/EffNet_IncepV3R1.h5'
...
root_logdir = '/media/tohn/SSD/Orther_model/R2/my_logs_IncepV3R2'
def get_run_logdir():
    import time
...
model.save('./models/EffNet_IncepV3R2.h5')